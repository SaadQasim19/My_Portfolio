...
document.addEventListener("DOMContentLoaded", () => {
  const elementsToObserve = document.querySelectorAll(
    ".section-title, .stat-item, .skills-text, .skills-bars, .experience-card, .contact-info, .contact-form, .stats, .project-card"
  );
...
document.addEventListener("DOMContentLoaded", () => {
  const elementsToObserve = document.querySelectorAll(
    ".section-title, .stat-item, .skills-text, .skills-bars, .experience-card, .contact-info, .contact-form, .stats"
  );
  elementsToObserve.forEach((el) => observer.observe(el));
});
